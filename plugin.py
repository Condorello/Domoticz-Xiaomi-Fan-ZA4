...
#        'off': 'Spento',
    ...
    def onStart(self):
        ...
        if self.angleControlUnit not in Devices:
            Domoticz.Device(Name='Oscillation Angle', Unit=self.angleControlUnit, TypeName='Selector Switch', Image=iconID, Options=self.angleOptions).Create()
        ...
        if self.modeControlUnit not in Devices:
            Domoticz.Device(Name='Mode Control', Unit=self.modeControlUnit, TypeName='Selector Switch', Image=iconID, Options=self.modeOptions).Create()
